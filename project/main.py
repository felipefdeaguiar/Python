...
if fuel_car == 0 and turbo_car == 1 and stage_car == 1:
    ...
    print('================== Concluido ================== ')
    print('')
    print(f'A potencia estimada do {model_car} do cliente {nome_client} foi para {whp_md_car} Whp')
    print('')
    print(f'O Torque estimado do {model_car} do cliente {nome_client} foi para {kgmf_md_car} kgf/m ')
    print('')
