...
#todo desafio 005 - crie um programa que leia um numero inteiro e mostre na tela seu sucessor e antecessor
...
#todo desafio 006 - crie um algoritmo que leia um número e mostre seu dobro, triplo e raiz quadrada
...
#todo desafio 007 - crie um programa que leia as notas do aluno, e calcule a sua média
...
#todo desafio 008 - crie um programa que leia em metros e exiba convertido em centimetros e milimetros
n1 = float(input('Desafio 008 - Digite os metros '))
ce = n1 * 100
mi = n1 * 1000
print('O valor convertido em cm é {:.0f} e em mm é {:.0f}'.format(ce, mi))

#todo desafio 009 - crie um programa que leia um numero inteiro e mostre sua tabuada
...
#todo desafio 011 - crie um programa que leia a largura e altura em metros de uma parede e calcule a sua
...
#todo desafio 012 - crie um programa que leia o preço do produto e mostre seu novo preço com 5% de desconto
...
#todo desafio 013 - crie um programa que leia o salario de um funcionario e mostre seu novo
